function Restore-Schema {
  ...
  Process {
    # Restore database back-up
    Invoke-RiskProANTClient -Path $Path -XML $XML -Operation "restoreSchema" -Properties $Properties
  }
}
