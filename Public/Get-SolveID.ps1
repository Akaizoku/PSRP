function Get-SolveID {
  <#
    .SYNOPSIS
    Get solve ID

    .DESCRIPTION
    Wrapper function to retrieve the unique identifier of an analysi using the RiskPro batch client
  ...
  Process {
    ...
    $OperationParameters.Add("ut.solveName", $Solve)
    $OperationParameters.Add("ut.solveKind", $Kind)
    ...
    # Query solve ID
  	Invoke-RiskProBatchClient -Properties $Properties -Credentials $Credentials -Operation "getSolveId" -Parameters $Parameters -Class $JavaClass
  }
}
