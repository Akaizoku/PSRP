function Unlock-User {
  <#
    ...
    .DESCRIPTION
    Wrapper function to unlock a user using the RiskPro batch client
    ...
    .PARAMETER UserName
    The user name parameter corresponds to the name of the model to check.

    .NOTES
    File name:      Unlock-User.ps1
  ...
  Process {
    ...
    # Unlock user
  	Invoke-RiskProBatchClient -JavaPath $JavaPath -RiskProPath $RiskProBatchClient -ServerURI $ServerURI -Credentials $Credentials -JavaOptions $JavaOptions -Operation "unlockUser" -Parameters $Parameters -Class $JavaClass
  }
}
