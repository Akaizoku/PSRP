function Invoke-DeleteUser {
  <#
    ...
    .DESCRIPTION
    Wrapper function to delete a user using the RiskPro batch client
    ...
    .PARAMETER UserName
    The user name parameter corresponds to the name of the user to delete.

    .NOTES
    File name:      Invoke-DeleteUser.ps1
  ...
  Process {
    ...
    # Create model
  	Invoke-RiskProBatchClient -JavaPath $JavaPath -RiskProPath $RiskProBatchClient -ServerURI $ServerURI -Credentials $Credentials -JavaOptions $JavaOptions -Operation "deleteUser" -Parameters $Parameters -Class $JavaClass
  }
}
